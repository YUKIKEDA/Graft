...
/// <summary>
/// One-shot SaveFile dialog arm state for the in-process agent (test seam).
/// </summary>
public static class SaveFileArm
{
    ...
    /// <summary>
    /// Arms the next <see cref="SaveFileArm"/> consumption to return <paramref name="path"/> (OK).
    /// </summary>
